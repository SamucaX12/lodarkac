  ...
  return (
    <div className="relative w-full min-h-screen bg-[#020202] text-[#e2e8f0] font-sans selection:bg-purple-500/30 overflow-x-hidden">
      ...
      <main className="relative z-10 flex flex-col items-center text-center px-6 pt-32 pb-40 max-w-7xl mx-auto">
        ...
        <h1 className="text-[12vw] lg:text-9xl font-black tracking-tighter leading-[0.8] uppercase mb-16 text-white text-center">
          O TOPO DA<br />
          <span className="text-transparent bg-clip-text bg-gradient-to-b from-white to-white/30">FORENSE.</span>
        </h1>

        <p className="text-sm md:text-base text-slate-500 max-w-2xl font-bold leading-relaxed mb-24 uppercase tracking-[0.2em] px-4">
          A elite da perícia digital. Engenharia reversa e detecção de artefatos de última geração para o cenário competitivo de alto nível.
        </p>

        <div className="flex flex-wrap items-center justify-center gap-8">
          <Link 
            href="/verify"
            className="px-16 py-6 bg-white text-black font-black rounded-3xl text-[11px] uppercase tracking-[0.4em] hover:bg-purple-600 hover:text-white transition-all duration-700 active:scale-95 shadow-[0_30px_60px_rgba(255,255,255,0.05)]"
          >
            VERIFICAR PIN
          </Link>
          <Link 
            href="/download"
            className="px-16 py-6 bg-white/[0.02] border border-white/10 text-white font-black rounded-3xl text-[11px] uppercase tracking-[0.4em] hover:border-purple-500/50 transition-all active:scale-95 backdrop-blur-3xl group"
          >
            BAIXAR SCANNER
        ...
        <div className="mt-48 w-full max-w-6xl relative group animate-in slide-in-from-bottom-20 duration-1000 px-4">
                  ...
                  <div className="space-y-12">
                      <div className="space-y-4">
                          ...
                          <div className="flex items-end gap-3">
                              <span className="text-7xl font-black text-white italic tracking-tighter">99.8%</span>
