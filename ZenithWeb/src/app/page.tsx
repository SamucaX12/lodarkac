    ...
    <div className="relative w-full min-h-screen bg-[#050505] text-[#e2e8f0] font-sans selection:bg-purple-500/30 overflow-x-hidden">
      ...
      <main className="relative z-10 flex flex-col items-center text-center px-6 pt-32 pb-40 max-w-7xl mx-auto">
        ...
        <div className="flex flex-wrap items-center justify-center gap-8">
          <Link 
            href="/download"
            className="px-20 py-6 bg-white text-black font-black rounded-full text-[11px] uppercase tracking-[0.4em] hover:bg-purple-600 hover:text-white transition-all duration-700 active:scale-95 shadow-[0_20px_50px_rgba(139,92,246,0.2)]"
          >
            {t('common.download')}
            <ArrowRight size={16} className="inline ml-3 group-hover:translate-x-2 transition-transform opacity-50" />
          </Link>
        </div>
