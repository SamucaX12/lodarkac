        ...
        <div className="mt-40 w-full animate-in fade-in duration-1000">
            ...
            <div className="flex flex-wrap items-center justify-center gap-x-20 gap-y-12 opacity-30">
                <div className="flex items-center gap-4 group hover:opacity-100 transition-opacity">
                    ...
                    <span className="text-xs font-black uppercase italic tracking-tighter text-white">TEAM LODARK</span>
                </div>
                <div className="flex items-center gap-4 group hover:opacity-100 transition-opacity">
                    <Terminal size={18} className="text-purple-600" />
                    <span className="text-xs font-black uppercase italic tracking-tighter text-white">SAMU AC</span>
                </div>
                <div className="flex items-center gap-4 group hover:opacity-100 transition-opacity">
                    <Eye size={18} className="text-purple-600" />
                    <span className="text-xs font-black uppercase italic tracking-tighter text-white">VISION SS</span>
                </div>
                <div className="flex items-center gap-4 group hover:opacity-100 transition-opacity">
                    <ShieldCheck size={18} className="text-purple-600" />
                    <span className="text-xs font-black uppercase italic tracking-tighter text-white">NAPSE AC</span>
                </div>
                <div className="flex items-center gap-4 group hover:opacity-100 transition-opacity">
                    <Search size={18} className="text-purple-600" />
                    <span className="text-xs font-black uppercase italic tracking-tighter text-white">FORENSICS ELITE</span>
                </div>
            </div>
        </div>
