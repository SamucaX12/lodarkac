                ...
                <div>
                    ...
                    <div className="relative group">
                        ...
                        <input
                            ...
                            className="w-full bg-white/[0.02] border border-white/5 rounded-2xl pl-14 pr-6 py-6 text-sm text-white placeholder-slate-800 focus:outline-none focus:border-purple-500/30 transition-all font-bold"
                ...
                <div>
                    ...
                    <div className="relative group">
                        ...
                        <input
                            ...
                            className="w-full bg-white/[0.02] border border-white/5 rounded-2xl pl-14 pr-14 py-6 text-sm text-white placeholder-slate-800 focus:outline-none focus:border-purple-500/30 transition-all font-bold"
                            placeholder="••••••••"
                            required
                        />
                        <button 
                    ...
                    <div className="animate-in fade-in slide-in-from-top-2 duration-500 space-y-6">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full bg-white/[0.02] border border-white/5 rounded-2xl px-6 py-6 text-sm text-white placeholder-slate-800 focus:outline-none focus:border-purple-500/30 transition-all font-bold"
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full bg-white/[0.02] border border-white/5 rounded-2xl px-6 py-6 text-sm text-purple-400 font-mono placeholder-slate-800 focus:outline-none focus:border-purple-500/30 transition-all"
