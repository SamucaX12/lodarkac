...
import { Users, ShieldAlert, Key, MapPin, MonitorPlay, Shield } from 'lucide-react';
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-white/5">
                ...
                {users.length === 0 && (
                  <tr>
                    <td colSpan={5} className="p-8 text-center text-gray-500 font-bold uppercase tracking-widest text-xs">Nenhum usuário registrado.</td>
                  </tr>
                )}
              </tbody>
            </table>
