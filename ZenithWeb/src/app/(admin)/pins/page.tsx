...
import { Key, Plus, Trash2, Search, Filter, ShieldCheck, Download } from 'lucide-react';
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-black/40 text-gray-600 text-[10px] uppercase tracking-[0.3em] font-black">
                ...
                <th className="px-10 py-6 whitespace-nowrap">Plano</th>
              ...
              {pins.length === 0 ? (
                ...
                pins.map((pin: any) => (
                  <tr key={pin._id.toString()} className="hover:bg-white/[0.02] transition-colors group">
                    ...
                    <td className="px-10 py-6">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 bg-white/5 rounded-xl border border-white/5 flex items-center justify-center group-hover:border-white/20 transition-all overflow-hidden p-1.5">
                           <img 
                             src={pin.game === 'FiveM' ? "https://i.postimg.cc/yYsJwjQ6/image.png" : "https://i.postimg.cc/L5z1j0xv/image.png"} 
                             alt="Game" 
                    ...
                    <td className="px-10 py-6">
                      <span className="px-3 py-1.5 rounded-lg text-[9px] font-black uppercase tracking-widest bg-white/5 text-gray-400 border border-white/10 group-hover:border-white/30 transition-all">
                        {pin.type || 'Padrão'}
                      </span>
                    </td>
                    <td className="px-10 py-6">
