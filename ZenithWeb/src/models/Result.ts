...
const resultSchema = new mongoose.Schema({
  ...
  ownerKey: { type: String, required: true, default: 'lodark_admin' }, // Quem gerou esse scan
  ...
  createdAt: { type: Date, default: Date.now, expires: 604800 } // TTL index: 7 dias (604800 segundos)
});
