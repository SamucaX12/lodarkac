...
const pinSchema = new mongoose.Schema({
  ...
  ownerKey: { type: String, required: true, default: 'lodark_admin' }, // A key do admin que gerou
  createdBy: { type: String, required: true, default: 'Lodark' }, // Username de quem gerou
