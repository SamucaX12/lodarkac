...
export default function GeneratePinButton() {
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  >
                    <option value="Free Fire" className="bg-[#0A0A0A]">Free Fire</option>
                    <option value="FiveM" className="bg-[#0A0A0A]">FiveM</option>
                  </select>
                </div>
