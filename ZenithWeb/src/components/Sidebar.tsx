...
import { Shield, LayoutDashboard, Key, Search, FileText, BarChart3, Settings, Briefcase, Users, SearchCode, LogOut } from "lucide-react";
          ...
          {adminAuth.includes('samuca244') ? (
            <>
              <div className="relative">
                <img src="https://i.pinimg.com/originals/4a/e4/d5/4ae4d5421f05c946d5f4ff9e0c2c93f0.jpg?nii=t" alt="Samuca" className="w-12 h-12 rounded-2xl object-cover border border-purple-500/50 shadow-[0_0_15px_rgba(168,85,247,0.3)]" />
            ...
            <>
              <div className="relative">
                <img src="https://tse1.mm.bing.net/th/id/OIP.FErCHkPZhfYpLNFFlr_2bgHaHa?rs=1&pid=ImgDetMain&o=7&rm=3" alt="Lodark" className="w-12 h-12 rounded-2xl object-cover border border-blue-500/50 shadow-[0_0_15px_rgba(59,130,246,0.3)]" />
                <div className="absolute -bottom-1 -right-1 w-4 h-4 bg-emerald-500 border-2 border-[#0A0A0A] rounded-full" />
              </div>
              <div className="flex flex-col">
