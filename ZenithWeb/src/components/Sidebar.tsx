    ...
    <aside className="w-72 bg-[#0A0A0A] min-h-screen border-r border-white/5 flex flex-col fixed z-40">
      ...
      <div className="p-6 border-t border-white/5 bg-white/5 backdrop-blur-sm">
        <div className="flex items-center gap-4 mb-6 px-2">
          {adminAuth.includes('lodark_admin') || adminAuth.includes('samuca244') ? (
            <>
              <div className="relative">
                <img src="https://i.postimg.cc/3xbh7jhh/image.png" alt="Lodark" className="w-12 h-12 rounded-2xl object-cover border border-indigo-500/50 shadow-[0_0_15px_rgba(99,102,241,0.3)]" />
                <div className="absolute -bottom-1 -right-1 w-4 h-4 bg-emerald-500 border-2 border-[#0A0A0A] rounded-full" />
              </div>
              <div className="flex flex-col">
                <span className="text-[11px] font-black text-white tracking-widest uppercase">Lodark</span>
