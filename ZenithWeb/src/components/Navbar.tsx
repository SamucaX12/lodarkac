    ...
    <nav className="relative z-50 flex items-center justify-between px-8 py-10 lg:px-20 bg-transparent">
      ...
      <div className="flex items-center gap-8">
        <div className="hidden lg:flex items-center gap-10 text-[9px] font-black uppercase tracking-[0.2em] text-slate-500">
          <Link href="/#tech" className="hover:text-white transition-colors">{t('nav.tech')}</Link>
          <Link href="/#partners" className="hover:text-white transition-colors">{t('nav.ecosystem')}</Link>
          <Link href="/verify" className="hover:text-white transition-colors">{t('nav.verification')}</Link>
        </div>
