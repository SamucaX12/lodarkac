...
type TabType = 'overview' | 'bam' | 'bypass' | 'forensics' | 'network' | 'services' | 'cheat' | 'generic';
...
export default function ResultClientView({ result, riskScore }: ResultProps) {
  ...
  const getRiskStatus = () => {
    ...
    if (riskScore < 65) return { label: 'SUSPEITO', color: 'text-blue-400', bg: 'bg-blue-500/[0.05]', border: 'border-blue-500/20' };
    return { label: 'CHEATING', color: 'text-red-500', bg: 'bg-red-500/[0.05]', border: 'border-red-500/20' };
  };
  ...
  return (
    <div className="min-h-screen bg-[#020202] text-slate-100 font-sans selection:bg-purple-500/30 overflow-x-hidden pb-40">
